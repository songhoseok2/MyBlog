    ...
    plugins: [
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.updateCommentHtml,
            filename: "../../templates/update_comment.html"
          },
          isEnvProduction
            ? {
                minify: {
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.error403Html,
            filename: "../../templates/errors/403.html"
          },
          isEnvProduction
            ? {
                minify: {
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.error404Html,
            filename: "../../templates/errors/404.html"
          },
          isEnvProduction
            ? {
                minify: {
      ...
      new HtmlWebpackPlugin(
        Object.assign(
          ...
          {
            inject: true,
            template: paths.error500Html,
            filename: "../../templates/errors/500.html"
          },
          isEnvProduction
            ? {
                minify: {
